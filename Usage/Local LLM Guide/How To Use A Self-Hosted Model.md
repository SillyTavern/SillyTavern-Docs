...
So if you have 12GB RAM and a 6GB VRAM GPU, you could run Llama2 13B Q6_K 4k, but only if you use GGUF and offload parts of the model to the GPU. (also take into account your OS's memory requirements as well. Windows is particularly RAM-hungry.)
